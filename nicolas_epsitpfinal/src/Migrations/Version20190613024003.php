 ...
 */
final class Version20190613024003 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attaque (id INT AUTO_INCREMENT NOT NULL, createdat DATETIME NOT NULL, deletedat DATETIME DEFAULT NULL, updateat DATETIME NOT NULL, isenable TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, damage INT DEFAULT NULL, type SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
